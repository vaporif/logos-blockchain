...
pub struct CoreMode<Service, RuntimeServiceId>(OnDemandServiceMode<Service, RuntimeServiceId>)
where
    Service: ServiceData;

impl<Service, RuntimeServiceId> CoreMode<Service, RuntimeServiceId>
where
