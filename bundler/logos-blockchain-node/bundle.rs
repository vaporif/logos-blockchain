...
const CRATE_NAME: &str = "logos-blockchain-node";
const CRATE_PATH_RELATIVE_TO_WORKSPACE_ROOT: &str = "nodes/logos-blockchain-node/node";
...
fn build_package(version: String) {
    ...
    let settings_builder = tauri_bundler::SettingsBuilder::new()
        ...
        .package_settings(tauri_bundler::PackageSettings {
            ...
            version,
            description: "Logos Blockchain Node".to_owned(),
            homepage: None,
            authors: None,
            default_run: None,
        })
